...
var carrot_plant_scene = preload("res://scenes/objects/plants/carrot.tscn")
...
func _unhandled_input(event: InputEvent) -> void:
	if event.is_action_pressed("remove_dirt"):
		...
		if ToolManager.selected_tool == DataTypes.Tools.PlantCarrot or ToolManager.selected_tool == DataTypes.Tools.PlantTomato:
			get_cell_under_mouse()
			add_crop()
